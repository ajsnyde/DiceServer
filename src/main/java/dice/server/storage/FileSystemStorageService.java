...
public class FileSystemStorageService implements StorageService {
	...
	public void store(File file) {
		try {
			...
			Files.copy(file.toPath(), this.rootLocation.resolve(file.toPath()), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
	...
	public void store(String filename, byte[] bytes) {
		try {
			...
			Files.write(this.rootLocation.resolve(new File(filename).toPath()), bytes, StandardOpenOption.CREATE,
